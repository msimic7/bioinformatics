...
const Lesson11 = () => (
  <div className={classes.root}>
    ...
    <p className={classes.indent1x}>
      ...
      doktori nisu uspeli da dijagnostikuju njegovo stanje. Nakon toga su 2010. godine odlučili da
      sekvencioniraju njegov genom i pronašli retku mutaciju u njemu na osnovu koje su otkrili
      defekt u njegovom imunom sistemu. Kao rezultat, imunoterapija mu je spasila život.
    </p>
    <p className={classes.indent1x}>
