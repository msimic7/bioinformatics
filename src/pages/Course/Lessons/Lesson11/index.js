...
const Lesson11 = () => (
  <div className={classes.root}>
    ...
    <Image src="/assets/lesson11/pic1.svg" className={`${classes.ml18}`} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson11/pic2.svg" className={`${classes.ml18}`} />
    <p className={classes.ml8}>
      Nedugo nakon toga, biolozi počinju sekvencioniranje genoma drugih vrsta:
    </p>
    <Image src="/assets/lesson11/pic3.svg" className={`${classes.ml18}`} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson11/pic4.svg" className={`${classes.ml18}`} />
    <p className={classes.ml8}>
