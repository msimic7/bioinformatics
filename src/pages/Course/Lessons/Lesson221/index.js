...
const Lesson221 = () => (
  <div className={classes.root}>
    ...
    <p className={classes.ml8}>Počnimo od sledećeg primera:</p>
    ...
    <Image src="/assets/lesson221/pic1.svg" className={classes.ml28} />
    <p className={classes.ml18}>
    ...
    <Image src="/assets/lesson221/pic2.svg" className={classes.ml28} />
    <p className={classes.ml18}>
    ...
    <Image src="/assets/lesson221/pic3.svg" className={classes.ml28} />
    <p className={classes.ml18}>
    ...
    <Image src="/assets/lesson221/pic4.svg" className={classes.ml28} />
    <p className={classes.ml18}>
    ...
    <Image src="/assets/lesson221/pic5.svg" className={classes.ml28} />
    <p className={classes.ml8}>
      Dirihleov princip nam predstavlja most koji nam omogućava korišćenje algoritama za tačno
      podudaranje:
    </p>
    <Image src="/assets/lesson221/pic6.svg" className={classes.ml18} />
...
def pribliznoPodudaranje(p, t, n):
  ...
  return list(priblizna_podudaranja)
    `}
      customClass={classes.ml18}
    />
    <p className={classes.ml8}>Testiramo datu funkciju na jednostavnom primeru:</p>
    <CodeEditor
      code={`
p = 'AACTTG'
t = 'CACTTAATTTG'
print(pribliznoPodudaranje(p, t, 2))
    ...
    [0, 5]`}
      customClass={classes.ml18}
    />
    <p className={classes.ml8}>Proveravamo tačnost:</p>
    <CodeEditor
      code={`
t[0:6]
    `}
