...
const Lesson10 = () => (
  <div className={classes.root}>
    ...
    <p className={`${classes.ml8} ${classes.mb4}`}>U sastav DNK ulaze tri komponente :</p>
    <p className={`${classes.ml18} ${classes.mb4}`}>DEZOKSIRIBOZA</p>
    ...
    <p className={`${classes.ml18} ${classes.mb4}`}>FOSFORNA GRUPA</p>
    ...
    <p className={`${classes.ml18} ${classes.mb4}`}>AZOTNE BAZE</p>
    ...
    <p className={`${classes.ml8} ${classes.mb4}`}>
    ...
    <p className={`${classes.ml8} ${classes.mb4}`}> ORIJENTACIJA DNK LANACA</p>
    <p className={`${classes.ml8}`}>
