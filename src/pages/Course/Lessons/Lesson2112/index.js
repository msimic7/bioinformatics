...
const Lesson2112 = () => (
  <div className={classes.root}>
    ...
    <p>PRIMER</p>
    <Image src="/assets/lesson2112/pic1.svg" className={classes.ml8} />
    <Image src="/assets/lesson2112/pic2.svg" className={classes.ml8} />
    ...
    <Image src="/assets/lesson2112/pic5.svg" className={classes.ml8} />
    <p className={classes.ml8}>Ponavljamo isti postupak.</p>
    <Image src="/assets/lesson2112/pic6.svg" className={classes.ml8} />
    <Image src="/assets/lesson2112/pic7.svg" className={classes.ml8} />
    <Image src="/assets/lesson2112/pic8.svg" className={classes.ml8} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson2112/pic9.svg" className={classes.ml8} />
    <p className={classes.ml8}>
      Pomeramo šablon u desno tako da se taj prefiks poravna sa istim sufiksom t.
    </p>
    <Image src="/assets/lesson2112/pic10.svg" className={classes.ml8} />
    <p className={classes.ml8}>
      Iz prethodna dva koraka možemo zaključiti da pomeranje šablona vršimo tako što nalazimo:
    </p>
    <p className={classes.ml18}>- podnisku šablona koja je jednak t ili </p>
    <p className={classes.ml18}>- prefiks šablona koji je jednak sufiksu od t </p>
    <p className={classes.ml8}>
      i zatim ih poravnamo tako da nijedno podudaranje karaktera ne postane nepodudaranje.
    </p>
    <p className={classes.ml8}>Kako nismo došli do kraja teksta, ponavljamo isti postupak:</p>
    <Image src="/assets/lesson2112/pic11.svg" className={classes.ml8} />
    <Image src="/assets/lesson2112/pic12.svg" className={classes.ml8} />
    <p className={classes.ml8}>Dobijamo podudaranje na poziciji 8.</p>
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson2112/pic13.svg" className={classes.ml8} />
    <p className={classes.ml8}>
      Pomeramo šablon tako da se zaokružene niske nađu jedna ispod druge:
    </p>
    <Image src="/assets/lesson2112/pic14.svg" className={classes.ml8} />
    <Image src="/assets/lesson2112/pic15.svg" className={classes.ml8} />
    <p className={classes.ml8}>Ponavljamo isti postupak sve dok ne dođemo do kraja teksta.</p>
    ...
    <Image src="/assets/lesson2112/pic16.svg" className={classes.ml8} />
    ...
    <p className={classes.ml8}>dokaz.</p>
    <p className={classes.ml8}>Prikažimo sledeću nisku x i njene granice s i r sledećom slikom:</p>
    <Image src="/assets/lesson2112/pic17.svg" className={classes.ml18} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson2112/pic18.svg" className={classes.ml18} />
    ...
    <Image src="/assets/lesson2112/pic19.svg" className={classes.ml8} />
    <p>
    ...
    <p>PRIMER</p>
    <Image src="/assets/lesson2112/pic20.svg" className={classes.ml8} />
    ...
    <Image src="/assets/lesson2112/pic21.svg" className={classes.ml18} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson2112/pic22.svg" className={classes.ml18} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson2112/pic23.svg" className={classes.ml8} />
    <p>
    ...
    <Image src="/assets/lesson2112/pic24.svg" className={classes.ml8} />
    <p>Važiće da je j = polozaj_granice[i].</p>
    <p>Tada pomeramo šablon za pomeraj[j].</p>
    <Image src="/assets/lesson2112/pic25.svg" className={classes.ml8} />
    <p>Odnosno, pomeraj[j] = j - i:</p>
    <Image src="/assets/lesson2112/pic26.svg" className={classes.ml8} />
    ...
    <Image src="/assets/lesson2112/pic27.svg" className={classes.ml8} />
    <p>Ako je niska s najduža granica šablona P, tada se možemo susresti sa dve situacije:</p>
    <p className={classes.ml8}>{`1. |s| <= |t|`}</p>
    <Image src="/assets/lesson2112/pic28.svg" className={classes.ml18} />
    <p className={classes.ml18}>Tada pomeramo šablon za pomeraj[i] = j:</p>
    <Image src="/assets/lesson2112/pic29.svg" className={classes.ml28} />
    <p className={classes.ml8}>{`2. |s| > |t|`}</p>
    <Image src="/assets/lesson2112/pic30.svg" className={classes.ml18} />
    <p className={classes.ml18}>
      Tada tražimo nisku r koja je granica šablona P i koja je kraći od s, odnosno tražimo najdužu
      granicu od s:
    </p>
    <Image src="/assets/lesson2112/pic31.svg" className={classes.ml28} />
    <p className={classes.ml18}>
      Imaćemo da je novo j = pozicija_granice[j] i jednu od sledeće dve situacije, kao i na početku:
    </p>
    <p className={classes.ml28}>{`1.  i <= j :`}</p>
    <Image src="/assets/lesson2112/pic32.svg" className={classes.ml38} />
    <p className={classes.ml38}>Šablon pomeramo za pomeraj[i] = j:</p>
    <Image src="/assets/lesson2112/pic33.svg" className={classes.ml48} />
    <p className={classes.ml28}>{`2. i > j`}</p>
    ...
    <Image src="/assets/lesson2112/pic34.svg" className={classes.ml18} />
    <p className={classes.ml18}>
    ...
    <Image src="/assets/lesson2112/pic35.svg" className={classes.ml18} />
    <Image src="/assets/lesson2112/pic36.svg" className={classes.ml18} />
    ...
    />
    <p className={classes.ml8}>Posmatrajmo sledeći deo prethodnog primera:</p>
    <Image src="/assets/lesson2112/pic37.svg" className={classes.ml18} />
    <p className={classes.ml18}>
    ...
    <Image src="/assets/lesson2112/pic38.svg" className={classes.ml18} />
    <p className={classes.ml18}>pomeraj[6] = 6 - 2 = 4</p>
    <p className={classes.ml18}>Pomeramo šablon za 4 mesta:</p>
    <Image src="/assets/lesson2112/pic39.svg" className={classes.ml18} />
    <Image src="/assets/lesson2112/pic40.svg" className={classes.ml18} />
  </div>
);
