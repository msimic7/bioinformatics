...
const Lesson13 = () => (
  <div className={classes.root}>
    ...
    <div>
      <img alt="" src="/assets/lesson13/pic1.svg" className={classes.indent1x} />
    </div>
    <p>
      Na osnovu ovakvog predstavljanja nukleotida, deo DNK prikazan na slici ispod će izgledati na
      sledeći način:
    </p>
    <img alt="" src="/assets/lesson13/pic2.svg" className={classes.indent1x} />
    ...
    <p>Na primer, sekvencioniramo Vaš genom.</p>
    <img alt="" src="/assets/lesson13/pic4.svg" className={classes.indent1x} />
    ...
    <h2 className={classes.indent1x}>CIKLUS 1</h2>
    <p className={classes.indent2x}>Korak 1</p>
    <div>
      <img alt="" src="/assets/lesson13/pic12.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 2</p>
    <div>
      <img alt="" src="/assets/lesson13/pic13.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 3</p>
    <div>
      <img alt="" src="/assets/lesson13/pic14.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 4</p>
    <div>
      <img alt="" src="/assets/lesson13/pic15.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 5</p>
    <div>
      <img alt="" src="/assets/lesson13/pic16.svg" className={classes.indent3x} />
    </div>
    <h2 className={classes.indent1x}>CIKLUS 2</h2>
    <p className={classes.indent2x}>Korak 1</p>
    <div>
      <img alt="" src="/assets/lesson13/pic17.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 2</p>
    <div>
      <img alt="" src="/assets/lesson13/pic18.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 3</p>
    <div>
      <img alt="" src="/assets/lesson13/pic19.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 4</p>
    <div>
      <img alt="" src="/assets/lesson13/pic20.svg" className={classes.indent3x} />
    </div>
    <p className={classes.indent2x}>Korak 5</p>
    <div>
      <img alt="" src="/assets/lesson13/pic21.svg" className={classes.indent3x} />
    </div>
    ...
    <p className={classes.indent2x}>Za data tri šablona dobili smo sledeća tri očitavanja:</p>
    <p className={classes.indent2x}>CGTCA</p>
    <p className={classes.indent2x}>AGTCC</p>
    <p className={classes.indent2x}>CGTGA</p>
    <p className={classes.indent2x}>
      Očitavanja su komplementi šablona, stoga šablone dobijamo primenom funkcije obrnutiKomplement
      na njih:
    </p>
    <p className={classes.indent2x}>TGACG</p>
    <p className={classes.indent2x}>GGACT</p>
    <p className={classes.indent2x}>TGACG</p>
    <p>
    ...
    <p>Da sumiramo, kod sekvencioniranja sintezom imamo:</p>
    <p>- bilion fragmenata koje treba da sekvencioniramo</p>
    <p>
    ...
    <p>Na primer, za jedan fragment to će izgledati na sledeći način:</p>
    <img alt="" src="/assets/lesson13/pic23.svg" className={classes.indent1x} />
    <p className={classes.indent1x}>
      Ponavljamo postupak koji smo prethodno opisali. Fotografija za prvi ciklus sekvencioniranja:
    </p>
    <img alt="" src="/assets/lesson13/pic24.svg" className={classes.indent2x} />
    <p className={classes.indent1x}>
    ...
    <img alt="" src="/assets/lesson13/pic26.svg" className={classes.indent3x} />
    <p className={classes.indent2x}>Nakon dodavanja te baze, naš fotoaparat pravi sliku:</p>
    <img alt="" src="/assets/lesson13/pic27.svg" className={classes.indent3x} />
    <p className={classes.indent1x}>Sledeći ciklus sekvencioniranja datog primera:</p>
    <p className={classes.indent2x}>
    ...
    <img alt="" src="/assets/lesson13/pic28.svg" className={classes.indent3x} />
    <p className={classes.indent2x}>
    ...
    <img alt="" src="/assets/lesson13/pic32.svg" className={classes.indent1x} />
    <p>
    ...
    <img alt="" src="/assets/lesson13/pic33.svg" className={classes.indent1x} />
    <p className={classes.indent1x}>
    ...
    <p>Kako određujemo Q? Pokažimo to na sledećem primeru:</p>
    <h2>PRIMER</h2>
