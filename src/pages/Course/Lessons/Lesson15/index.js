...
const Lesson15 = () => (
  <div className={classes.root}>
    ...
    <p className={classes.ml8}>OČITAVANJE KAO PODNISKA</p>
    ...
    <p className={classes.ml18}>Želimo da sekvencioniramo sledeći genom:</p>
    <Image src="/assets/lesson15/pic1.svg" className={classes.ml28} />
    ...
    <Image src="/assets/lesson15/pic2.svg" className={classes.ml28} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson15/pic3.svg" className={classes.ml18} />
    <p className={classes.ml8}>
      Problem rekonstrukcije genoma na osnovu očitavanja analogan je{' '}
      <b>problemu eksplodirajućih novina</b>:
    </p>
    <p className={classes.ml8}>PROBLEM EKSPLODIRAJUĆIH NOVINA</p>
    <p className={classes.ml18}>
    ...
    <Image src="/assets/lesson15/pic4.svg" className={classes.ml28} />
    <p className={classes.ml8}>
    ...
    <Image src="/assets/lesson15/pic6.svg" className={classes.ml18} />
    <p className={classes.ml8}>
      Na sličan način ćemo to raditi i pri sastavljanju genoma samo na osnovu dobijenih očitavanja:
    </p>
    <Image src="/assets/lesson15/pic7.svg" className={classes.ml18} />
    <p className={classes.ml8}>
